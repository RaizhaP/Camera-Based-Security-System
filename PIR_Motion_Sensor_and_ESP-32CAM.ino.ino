...
String BOTtoken = "Telegram Token";  // your Bot Token (Get from Botfather)
...
String sendPhotoTelegram() {
  ...
  bot.sendMessage(CHAT_ID, "Ada Pergerakkan!!", "");
  ...
  if (clientTCP.connect(myDomain, 443)) {
    ...
    clientTCP.println("Content-Type: multipart/form-data; boundary=Name");
    clientTCP.println();
